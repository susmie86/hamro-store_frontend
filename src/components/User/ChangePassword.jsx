...
function ChangePassword() {
  ...
  const showCurrentPassword = () => {
    setIsPasswordHidden((prevIsPasswordHidden) => {
      return {
        ...
        current: !prevIsPasswordHidden.current,
      };
    });
  };
  ...
  const showConfirmNewPassword = () => {
    ...
    setIsPasswordHidden((prevIsPasswordHidden) => {
      return {
        ...prevIsPasswordHidden,
        current: !prevIsPasswordHidden.confirmNew,
      };
    });
  };
  return (
    <div className="field-set password">
      ...
      >
        ...
        <span onClick={showCurrentPassword}>
          <FontAwesomeIcon
            icon={isPasswordHidden.current ? faEye : faEyeSlash}
          />
        </span>
      </div>
      ...
      >
        ...
        <span onClick={showConfirmNewPassword}>
          <FontAwesomeIcon
            icon={isPasswordHidden.confirmNew ? faEye : faEyeSlash}
          />
        </span>
      </div>
    </div>
